...
## 📌 주요 기능
- 이메일 회원가입, 로그인 기능 <br>
- 매물 등록 및 이미지 업로드 기능 / 실시간 매물 조회 및 필터링 기능 <br>
- 매물기반 좋아요 / 댓글 / 전화 / 문자 발송 기능 <br>
- 사용자 현재 위치 기반으로 지도에 매물 표시 및 장소 검색 <br>
- 계약금을 바로 지급할 수 있는 결제기능 구현 <br>
- 좋아요 게시글, 작성글, 계약금 결제건 관리 기능 <br>
<br>
